...
public class ScoreAPI {
    ...
    public static void setScoreboard(Player player) {
        ...
        obj.setDisplayName("§7» §6BedWarsHub §7«");
        ...
        obj.getScore("§7Stats§7:").setScore(5);
        obj.getScore("§7» §c§l❌").setScore(4);
        obj.getScore("   ").setScore(3);
        //obj.getScore("§7TeamSpeak§7:").setScore(2);
        //obj.getScore("§7» §6ts.HypeTime.eu").setScore(1);
        obj.getScore("§7Ranking§7:").setScore(2);
        obj.getScore("§7»§6 §c§l❌").setScore(1);
    ...
    public static void startScheduler() {
        Bukkit.getScheduler().runTaskTimerAsynchronously(BedWarsHub.getInstance(), () -> {
            if (count > 7) {
                count = 0;
            } else {
                count++;
            ...
            for (Player on : Bukkit.getOnlinePlayers()) {
                switch (count) {
                    case 7:
                        on.spigot().sendMessage(ChatMessageType.ACTION_BAR, UUID.randomUUID(), TextComponent.fromLegacyText("§c§lBETA"));
                    case 6:
                    ...
                    case 4:
                        ...
                        break;
                    case 3:
                        on.spigot().sendMessage(ChatMessageType.ACTION_BAR, UUID.randomUUID(), TextComponent.fromLegacyText("§6Website §8| §7www.hypetime.eu"));
                        break;
                    case 2:
